    ...
    <body>
        <div id="menulateral">
             <div id="icones">
                ...
                <img id="contatos" class="iconorganizer" src="../static/img/contatos.png" width="100%" height="100%">
            </div>
        </div>
        
        
        <div id="conteudo">
            <iframe id="pagainas" src="menu.php"></iframe>
        </div>
      <?php
...
<!--      <div id="menuuserimg">
      ...
      <div id="menuuserinfo">
        <?php            
            $query = "SELECT * FROM \"Dicionario\".\"admin\" where \"user\" = '".$_SESSION['login']."';";
            $result = mysqli_query($conexao,$query);
            while ($row = mysqli_fetch_assoc($result)) {
                echo($row['nome']);
            }
